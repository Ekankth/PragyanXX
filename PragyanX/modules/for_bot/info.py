...
from PragyanX.functions import get_user, get_id
...
async def _info(PragyanX: Client, e: Message):
   try:
      user = await get_user(PragyanX, e)
...
async def _id(PragyanX: Client, e: Message):
   await get_id(PragyanX, e)
