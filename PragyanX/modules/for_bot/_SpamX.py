...
from PragyanX.core import user_errors 
from PragyanX.core.help_strings import *
from PragyanX.functions import user_only, delete_reply
...
def _eval(PragyanX: Client, message: Message):
...
async def _telegraph(PragyanX: Client, message: Message):
    ...
    if message.reply_to_message.media:
        ...
        _title = get_text(message) if get_text(message) else PragyanX.me.first_name
