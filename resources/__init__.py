...
def PragyanX_Setup():
    ...
    clear()
    print(f'    {white}PragyanX Version: v0.5 \n    {white}By RiZoeX')
...
def get_start():
    clear(fast=True)
    question = input(f"{ask}Wanna start PragyanX Now?: y/n: ")
    if question.lower() == "y":
        os.system("pip3 install python-dotenv")
        os.system("python3 -m PragyanX")
    elif question.lower() == "n":
        print(f"\n{info}Nevermind !! You Can Start It Later With by using; python3-m PragyanX\n")
        exit(2)
    else:
        os.system("clear")
